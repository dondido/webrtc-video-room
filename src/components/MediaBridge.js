    ...
    return (
      <div className={this.state.bridge}>
        ...
        <div className="media-controls">
          ...
          <button onClick={this.handleFullScreen} className={'fullscreen-button-' + this.state.full}>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" className="svg">
          ...
          <button onClick={this.handleHangup}>
            <svg id="hangup" className="hidden" xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="-10 -10 68 68">
